# nf-core/moleculardocking Pipeline Diagram
...
flowchart LR
    ...
    subgraph Docking
        I["MOLECULARDOCKING_DOCK\nAutoDock Vina"]
    end

    subgraph Analysis
        J["MOLECULARDOCKING_PARSE"]
        K["SCORE_AGGREGATE"]
        L["MULTIQC"]
    end
...
| 5 | MOLECULARDOCKING_DOCK | AutoDock Vina | Perform molecular docking |
| 6 | MOLECULARDOCKING_PARSE | Python | Extract binding affinities and poses |
