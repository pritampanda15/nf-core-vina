<h1>
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="docs/images/nf-core-moleculardocking_logo_dark.png">
    <img alt="nf-core/moleculardocking" src="docs/images/nf-core-moleculardocking_logo_light.png">
  </picture>
</h1>

[![Open in GitHub Codespaces](https://img.shields.io/badge/Open_In_GitHub_Codespaces-black?labelColor=grey&logo=github)](https://github.com/codespaces/new/nf-core/moleculardocking)
[![GitHub Actions CI Status](https://github.com/nf-core/moleculardocking/actions/workflows/nf-test.yml/badge.svg)](https://github.com/nf-core/moleculardocking/actions/workflows/nf-test.yml)
[![GitHub Actions Linting Status](https://github.com/nf-core/moleculardocking/actions/workflows/linting.yml/badge.svg)](https://github.com/nf-core/moleculardocking/actions/workflows/linting.yml)[![AWS CI](https://img.shields.io/badge/CI%20tests-full%20size-FF9900?labelColor=000000&logo=Amazon%20AWS)](https://nf-co.re/moleculardocking/results)[![Cite with Zenodo](http://img.shields.io/badge/DOI-10.5281/zenodo.XXXXXXX-1073c8?labelColor=000000)](https://doi.org/10.5281/zenodo.XXXXXXX)
...
[![Launch on Seqera Platform](https://img.shields.io/badge/Launch%20%F0%9F%9A%80-Seqera%20Platform-%234256e7)](https://cloud.seqera.io/launch?pipeline=https://github.com/nf-core/moleculardocking)

[![Get help on Slack](http://img.shields.io/badge/slack-nf--core%20%23moleculardocking-4A154B?labelColor=000000&logo=slack)](https://nfcore.slack.com/channels/moleculardocking)[![Follow on Bluesky](https://img.shields.io/badge/bluesky-%40nf__core-1185fe?labelColor=000000&logo=bluesky)](https://bsky.app/profile/nf-co.re)[![Follow on Mastodon](https://img.shields.io/badge/mastodon-nf__core-6364ff?labelColor=FFFFFF&logo=mastodon)](https://mstdn.science/@nf_core)[![Watch on YouTube](http://img.shields.io/badge/youtube-nf--core-FF0000?labelColor=000000&logo=youtube)](https://www.youtube.com/c/nf-core)

## Introduction

**nf-core/moleculardocking** is a high-throughput, containerized molecular docking pipeline using **AutoDock Vina** with modern ligand and receptor preparation tools. It is designed for structure-based virtual screening campaigns in drug discovery.

![workflow](docs/images/nf-core-moleculardocking.png)
...
For more details and further functionality, please refer to the [usage documentation](https://nf-co.re/moleculardocking/usage) and the [parameter documentation](https://nf-co.re/moleculardocking/parameters).
...
nf-core/moleculardocking was originally written by Pritam Kumar Panda.
...
For further information or help, don't hesitate to get in touch on the [Slack `#moleculardocking` channel](https://nfcore.slack.com/channels/moleculardocking) (you can join with [this invite](https://nf-co.re/join/slack)).
